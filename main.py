...
sys_des = pd.read_csv("C:\\Users\\Varun Sampat\\Downloads\Medicine_Recommendation_System-main\\Medicine_Recommendation_System-main\\symtoms_df.csv")
precautions = pd.read_csv("C:\\Users\\Varun Sampat\\Downloads\Medicine_Recommendation_System-main\\Medicine_Recommendation_System-main\\precautions_df.csv")
workout = pd.read_csv("C:\\Users\\Varun Sampat\\Downloads\Medicine_Recommendation_System-main\\Medicine_Recommendation_System-main\\workout_df.csv")
description = pd.read_csv('C:\\Users\\Varun Sampat\\Downloads\Medicine_Recommendation_System-main\\Medicine_Recommendation_System-main\\description.csv')
medication = pd.read_csv("C:\\Users\\Varun Sampat\\Downloads\Medicine_Recommendation_System-main\\Medicine_Recommendation_System-main\\medications.csv")
diets = pd.read_csv('C:\\Users\\Varun Sampat\\Downloads\Medicine_Recommendation_System-main\\Medicine_Recommendation_System-main\\diets.csv')

svc = pickle.load(open("C:\\Users\\Varun Sampat\\Downloads\\Medicine_Recommendation_System-main\\Medicine_Recommendation_System-main\\SVC.pkl",'rb'))
